...
with_COT_code_output_prompt = r'''Solve the following question using your coding skills.
    Suggest python code (in a python coding block) for the user to execute.
