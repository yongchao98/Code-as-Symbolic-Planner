...
def run_blocksworld(dataset_input_dir, save_input_dir, gather_save_input_dir, model_name, max_tree_depth, args_path, CodeSteer_LLM):
    ...
    for index in range(5):
        ...
        (5, 3, 3), (5, 4, 3), (6, 3, 3), (6, 4, 3), (7, 3, 3), (7, 4, 3), (8, 3, 3), (8, 4, 3), (9, 3, 3), (9, 4, 3),
            ...
            token_num = count_total_tokens(response_list, user_prompt_list)
    ...
    run_info_result = f'correct/all:{total_correct_num}/{total_sample_num}, average token len: {np.mean(token_num_list)}, average runtime: {np.mean(runtime_list)}\n'
