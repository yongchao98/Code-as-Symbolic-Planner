...
def run_boxlift(dataset_input_dir, save_input_dir, gather_save_input_dir, model_name, max_tree_depth, args_path, CodeSteer_LLM):
    ...
    base_save_code_dir = save_input_dir + f'/result_boxlift_{CodeSteer_LLM}_{model_name}_MTD_{max_tree_depth}_CodeSteer_2'
    ...
    for iteration_num in range(5):
        for num_boxes, num_lifters, min_box_weight, max_box_weight, min_lifter_capacity, max_lifter_capacity in \
            [(8, 3, 10, 100, 40, 80), (12, 4, 20, 200, 30, 120), (16, 5, 30, 300, 40, 160), (20, 6, 40, 400, 50, 200),
             (24, 6, 40, 400, 50, 200),
             (8, 4, 10, 100, 40, 80), (12, 5, 20, 200, 30, 120), (16, 6, 30, 300, 40, 160), (20, 7, 40, 400, 50, 200),
             (24, 7, 40, 400, 50, 200),
             (28, 6, 40, 400, 50, 200), (28, 7, 40, 400, 50, 200), (32, 6, 60, 600, 70, 250), (32, 7, 60, 600, 70, 250)
             ]:
            total_sample_num += 1
            ...
            if not os.path.exists(save_code_dir + f"/code_1_0.py"):
                ...
                try:
                    ...
                    response = ""
                    errors = str(e)
            if count_total_tokens([response + errors], []) > 2000:
